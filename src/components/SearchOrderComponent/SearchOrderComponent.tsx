      ...
      <div>
        ...
        <div className="flex justify-center w-full flex-col items-center">
          <div className="w-full text-center flex justify-center items-center h-14 text-xl text-white bg-gradient-to-r from-indigo-500 via-sky-500 via-30% to-emerald-500">
            Nhập thông tin tìm kiếm đơn hàng
          </div>
          <div className="flex w-9/12 sm:w-11/12 md:w-11/12 flex-col my-6">
            <div>
              <div className="mb-4 w-full grid grid-cols-4 gap-4 sm:grid-cols-1 sm:gap-1 md:grid-cols-2 md:grid-2 lg:grid-cols-4 lg:grid-4">
                <div>
                  ...
                  {maDonHang === "" && (
                    <div className="text-red-500 text-sm text-start">
                      *Bạn cần điền mã đơn hàng để tra cứu
                    </div>
                  )}
                </div>
                <div>
                ...
                <button
                  className="flex justify-center items-center text-center text-base text-white bg-red-500 h-12 rounded-lg"
            ...
            <div className="border ">
              ...
              <div className="flex justify-center items-center sm:flex-col">
                <div className="w-1/2 border-r sm:w-full md:w-full">
                  <div className="h-14 border-b flex justify-center items-center text-center bg-red-500 text-white text-xl">
                    Thông tin người đặt
                  </div>
                  <div>
                    <p className="h-14 border-b flex justify-start items-center text-start text-lg ">
                      Họ và tên:{" "}
                      <span className="text-red-500 ml-2">
                        {dataOrder?.[0]?.username}
                      </span>
                    </p>
                    <p className="h-14 border-b flex justify-start items-center text-start text-lg ">
                      Số điện thoại:{" "}
                    ...
                    <p className="h-14 border-b flex justify-start items-center text-start text-lg ">
                      Trạng thái đơn hàng:{" "}
                      <span className="text-red-500 ml-2">
                        {dataOrder?.[3]?.orderstatus}
                      </span>
                    </p>
                    <p className="h-14 border-b flex justify-start items-center text-start text-lg ">
                      Trạng thái thanh toán:{" "}
                      <span className="text-red-500 ml-2">
                        {dataOrder?.[2]?.paymentstatus
                          ? "Đã thanh toán"
                          : "Chưa thanh toán"}
                      </span>
                    </p>
              ...
              <div>
                <div className="w-full text-center flex justify-center items-center h-14 text-xl text-white bg-gradient-to-r from-indigo-500 via-sky-500 via-30% to-emerald-500">Thông tin sản phẩm</div>
                  {dataOrder[2]?.map((item: any, index: any) => {
                    return (
                      <div key={index}>
                      <p className="h-14 border-b flex justify-start items-center text-start text-lg ">
                      Tên sản phẩm:{" "}
                    ...
                    <div className="border-b flex justify-start items-center text-start text-lg my-3">
                      Hình ảnh sản phẩm:{" "}
